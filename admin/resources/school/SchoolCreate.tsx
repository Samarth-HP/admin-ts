  ...
  return (
    <Create>
      <SimpleForm>
        ...
        <SelectInput source="location.data.district" choices={districts} validate={inputConstraints.district} />
        <SelectInput source="location.data.block" choices={blocks} validate={inputConstraints.block} />
        <SelectInput source="location.data.cluster" choices={clusters} validate={inputConstraints.cluster} />
